...
- `collaborationMode/list` — list available collaboration mode presets (experimental, no pagination); accepts optional `threadId` to derive built-in instructions from that thread's effective feature overrides.
